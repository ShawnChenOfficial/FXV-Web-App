...
namespace FXV_App.Migrations
{
    ...
    [Migration("20191212052725_20191210074622_migration_version_20191212_v4")]
    partial class _20191210074622_migration_version_20191212_v4
    {
            ...
            modelBuilder.Entity("FXV.Models.Splits_Tests", b =>
                {
                    ...
                    b.Property<int?>("Tests_ResultTR_ID");

                    b.HasKey("ST_ID");

                    b.HasIndex("Tests_ResultTR_ID");
            ...
            modelBuilder.Entity("FXV.Models.Splits_Tests", b =>
                {
                    b.HasOne("FXV.Models.Test_Result", "Tests_Result")
                        .WithMany()
                        .HasForeignKey("Tests_ResultTR_ID");
                });
